...
Backend service untuk aplikasi **SayurMart** — platform e-commerce sayur dan buah segar langsung dari petani.  
...
```bash
  git clone https://github.com/rikiteguhmaulana/be-sayurmart.git
  cd be-sayur-segar
```
